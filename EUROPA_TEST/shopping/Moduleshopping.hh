#ifndef _H_Moduleshopping
#define _H_Moduleshopping

#include "Module.hh"

namespace EUROPA {
  class Moduleshopping : public Module
  {
    public:
      Moduleshopping();
      virtual ~Moduleshopping();
  ...
  typedef Id<Moduleshopping> ModuleshoppingId;  
}  


#endif /* #ifndef _H_Moduleshopping */
